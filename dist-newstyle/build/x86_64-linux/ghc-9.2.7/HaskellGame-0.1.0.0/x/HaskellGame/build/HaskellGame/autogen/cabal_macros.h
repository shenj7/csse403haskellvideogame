...
/* package HaskellGame-0.1.0.0 */
#ifndef VERSION_HaskellGame
#define VERSION_HaskellGame "0.1.0.0"
#endif /* VERSION_HaskellGame */
#ifndef MIN_VERSION_HaskellGame
#define MIN_VERSION_HaskellGame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellGame */
...
#define CURRENT_COMPONENT_ID "HaskellGame-0.1.0.0-inplace-HaskellGame"
